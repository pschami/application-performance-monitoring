...
/**
 * Application Performance Rabbit config.
 * <p>
 * Copyright &copy; 2017 Dell Inc. or its subsidiaries.  All Rights Reserved.
 * </p>
 *
...
public class ApplicationPerformanceRabbitConfig
{
     ...
     */
    private static final Logger LOGGER                                  = LoggerFactory.getLogger(ApplicationPerformanceRabbitConfig.class);
    /**
    ...
    /**
     * This returns the <code>FanoutExchange</code> for the application performance
     * events.
     *
